      ...
      <div class="card" style="width: 35rem;">
        ...
        <div class="card-body">
          <div class="input-group mb-3 mr-sm-2">
            ...
            <input type="text" class="form-control" id="facebook" placeholder="Lien Facebook">
          </div>
          <div class="input-group mb-3 mr-sm-2">
            <div class="input-group-prepend">
              <div class="input-group-text"><i class="fab fa-instagram-square"></i></div>
            </div>
            <input type="text" class="form-control" id="instagram" placeholder="Lien Instagram">
          </div>
          <div class="input-group mb-4 mr-sm-2">
            <div class="input-group-prepend">
              <div class="input-group-text"><i class="fab fa-twitter-square"></i></div>
            </div>
            <input type="text" class="form-control" id="twitter" placeholder="Lien Twitter">
          </div>
          <div class="form-group text-center">
            <textarea name="description" id="" cols="60" rows="11" placeholder="Une phrase d'accroche, quelques mots sur votre restaurant..."></textarea>
          </div>
        </div>
        <div class="card-footer text-center">
          <a href="<? echo base_url('back/restaurant')?>" class="btn btn-info">Enregistrer les modifications</a>
        </div>
      </div>
        ...
        <div class="card-body">
          ...
          <div class="form-group">
            <div class="input-group mb-3">
              ...
              <input type="text" class="form-control" name="web_url" value="" placeholder="Choisissez votre logo d'entête">
            </div>
            <input type="file" class="form-control-file mb-4" name="photo_url">
          </div>
          ...
          <input type="file" class="form-control-file mt-3" name="fond_perso">
        </div>
      </div>
    <div>
</div>
