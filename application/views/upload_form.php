...
<div class="container-fluid fond-grey">
    ...
    <div class="row mx-auto justify-content-between border-top border-dark">
        ...
        <div class="col-lg-9 col-md-12 col-sm-12">
            <h4 class="text-center mt-3 mb-4">Gérer vos images</h4>
                ...
                <div class="d-flex justify-content-start">
                    <div>
                        <div class="alert alert-info" role="alert">
                            <p><strong>Pour votre photo de restaurant :</strong> merci de choisir un fichier gif, jpg ou png (max size : 200Ko).</p>
                            <?if(isset($photo_name)){?>
